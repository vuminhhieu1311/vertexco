                ...
                <div class="d-flex flex-column gap-7 gap-lg-10">
                    <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                        ...
                        <a href="{{ route('orders.edit', ['order' => $order->id]) }}"
                            class="btn btn-light-primary btn-sm me-lg-n7">Edit Order</a>
                        <!--end::Button-->
                    </div>
                    <!--begin::Order summary-->
                                    ...
                                    <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-bolder text-end">31/12/2021</td>
                                            </tr>
                                            <!--end::Date-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-5">
                                                            <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html"
                                                                class="fw-bolder text-gray-600 text-hover-primary">Product
                                                                1</a>
                                                            <div class="fs-7 text-muted">Delivery Date: 31/12/2021
                                                            </div>
                                                        </div>
                                                        <!--end::Title-->
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-5">
                                                            <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html"
                                                                class="fw-bolder text-gray-600 text-hover-primary">Footwear</a>
                                                            <div class="fs-7 text-muted">Delivery Date: 31/12/2021
                                                            </div>
                                                        </div>
                                                        <!--end::Title-->
