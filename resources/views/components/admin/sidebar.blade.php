    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link @if (Route::is('posts.*')) active @endif"
                ...
                <div class="menu-item">
                    <a class="menu-link @if (Route::is('users.*')) active @endif"
                        ...
                        <span style="margin-left:-2px;" class="menu-icon svg-icon svg-icon-muted svg-icon-2hx"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="menu-item">
                    <a class="menu-link @if (Route::is('setting')) active @endif"
                        href="{{ route('setting') }}">
                        <!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen049.svg-->
                        <span style="margin-left:-2px;" class="menu-icon svg-icon svg-icon-muted svg-icon-2hx"><svg xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                {{-- @can(\App\Enums\PermissionName::MANAGE_PERMISSIONS)
                    <div data-kt-menu-trigger="click"
                        ...
                        <span class="menu-link">
                            ...
                            <span class="menu-title">{{ __('messages.manage_permissions') }}</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            <div class="menu-item">
