        ...
        <div class="auto-container clearfix">
            ...
            <div class="outer-box">
                ...
                <div class="appoinment-btn">
                    ...
                    <a class="thm-btn pt-5 pb-5 mt-5 letter-spacing-1" data-toggle="modal"
                        href="#modal-donate-now">Appoinment</a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="appoinment-form-outer">
                                        <form action="http://vision.to/garden-plant/contact.html"
                                            method="post">
                                            ...
                                            <div class="form-portlet">
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="form-group col-lg-12 col-md-12 col-xs-12">
                                                        <div class="field-label">Name <span
                                                    ...
                                                    <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                                        <div class="field-label">Email <span
                                                                class="required">*</span></div>
                                                    ...
                                                    <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                                        <div class="field-label">Phone <span
                                                                class="required">*</span></div>
                                                        <input type="text" required=""
                                                    ...
                                                    <div class="form-group date col-lg-6 col-md-6 col-xs-12">
                                                        ...
                                                        <input class="datepicker" type="text"
                                                            required="" placeholder="MM/DD/Year"
                                                            value="" name="name">
                                                    </div>

                                                    <div class="form-group time col-lg-6 col-md-6 col-xs-12">
                                                        <div class="field-label">Time<span
                                                                class="required">*</span></div>
                                                        <input type="text" class="timepicker"
                                                            required="" placeholder="Time" value=""
                                                            name="name">
                                                    </div>
