                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="title" class="form-control mb-2"
                                                placeholder="Tiêu đề" value="" id="title-input" />
                                            <!--end::Input-->
                                            <div id="error-message-title" class="error-message text-danger"></div>
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="slug" class="form-control mb-2"
                                                placeholder="Đường dẫn" value="" id="slug-input" />
                                            <!--end::Input-->
                                            <div id="error-message-slug" class="error-message text-danger"></div>
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <textarea name="excerpt" class="form-control mb-2" rows="4" placeholder="Mô tả"></textarea>
                                            <!--end::Input-->
                                            <div id="error-message-excerpt" class="error-message text-danger"></div>
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-10 fv-row">
                                        ...
                                        <input type="hidden" id="product-description" name="content" />
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            ...
                                            <input type="number" name="order" class="form-control mb-2"
                                                placeholder="Số thứ tự" value="1" min="1" />
                                            <!--end::Input-->
                                            <div id="error-message-order" class="error-message text-danger"></div>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Card header-->
