                                ...
                                <div class="ml-25">
                                    ...
                                    @else
                                        <form method="POST"
                                            ...
                                            @csrf
                                            @include('components.edit_rating')
                                            <div class="w-75 mt-5">
                                                <textarea class="form-control" name="comment" placeholder="{{ __('messages.comment') }}"
                                                    aria-label="With textarea"></textarea>
                                            </div>
                                            <button type="submit" class="btn btn-primary mt-5 py-2">
