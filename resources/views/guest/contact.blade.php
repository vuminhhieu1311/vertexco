...
@section('content')
    ...
    <div class="container mx-auto pt-16 pb-24 px-8">
        <div class="relative pr-0 p-24">
            <div class="absolute inset-0 overflow-hidden -mx-4">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center relative">
                ...
                <div class="text-white" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <h2 class="contact-form-title mb-8" style="color:#fff">HÃY TIN TƯỞNG VÀO DỊCH VỤ CỦA CHÚNG TÔI ĐỂ GIÚP
                        BẠN TIẾP TỤC HÀNH
                        TRÌNH!
                    </h2>
                    <p class="mb-8"
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <div class="contact-info-title">ĐỊA CHỈ</div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <div class="contact-info-title">SỐ ĐIỆN THOẠI</div>
                                <div class="contact-info-desc flex gap-4">
        ...
        <div class="mt-24">
            <h2 class="about-title mb-8 uppercase text-center" data-aos="fade-up" data-aos-duration="800">ghé thăm văn phòng của chúng tôi</h2>
