            ...
            @for ($i = 1; $i <= 8; $i++)
                <div class="flex flex-col md:flex-row gap-6" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="{{ $i * 100 }}">
                    ...
                    <div class="w-full md:w-2/3 flex flex-col justify-center space-y-2 md:space-y-3">
                        <div class="news-card-tag">BLOGS</div>
                        ...
                        <p class="news-card-desc line-clamp-3 sm:line-clamp-4">Với cam kết vì một tương lai xanh, Vertexco không chỉ giúp khách hàng tối
