...
@section('content')
    @include('components.admin.header', ['parent' => 'Categories', 'child' => 'Add Category'])
    <!--begin::Content-->
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                    data-kt-redirect="../../demo8/dist/apps/ecommerce/catalog/category.html">
                    <!--begin::Aside column-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline mb-3"
                                    ...
                                    style="background-image: url(metronic/assets/media/svg/files/blank-image.svg)">
