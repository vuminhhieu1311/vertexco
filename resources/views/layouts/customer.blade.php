    ...
    <div id="page">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-sm-3 col-xs-12">
                            ...
                            <!-- Header Logo -->
                            <div class="logo"><a title="ecommerce Template" href="index.html"><img
                                        alt="ecommerce Template" src="fabulous/images/logo.png"></a></div>
                            <!-- End Header Logo -->
                            <div class="nav-icon">
                                    ...
                                    <div class="navleft-container">
                                        ...
                                        <div class="mega-menu-category">
                                            <ul class="nav">
                                                    ...
                                                    <div class="wrap-popup">
                                                        <div class="popup">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <ul class="nav">
                                                                        <li><a href="shop-grid.html"><span>Shop
                                                                                    Grid</span></a></li>
                                                                        <li><a href="shop-grid-sidebar.html"><span>Shop
                                                                                    Grid Sidebar</span></a></li>
                                                                        <li><a href="shop-list.html"><span>Shop
                                                                                    List</span></a></li>
                                                                        <li><a href="shop-list-sidebar.html"><span>Shop
                                                                                    List Sidebar</span></a></li>
                                                                        <li><a href="product-detail.html"><span>Product
                                                                                    Detail</span></a></li>
                                                                        <li><a href="product-detail-sidebar.html"><span>Product
                                                                                    Detail Sidebar</span></a></li>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <ul class="nav">
                                                                        ...
                                                                        <li><a
                                                                                href="wishlist.html"><span>Wishlist</span></a>
                                                                        </li>
                                                                        <li><a
                                                                                href="dashboard.html"><span>Dashboard</span></a>
                                                                        </li>
                                                                        <li><a
                                                                                href="compare.html"><span>Compare</span></a>
                                                                        </li>
                                                                        <li><a href="quick-view.html"><span>Quick
                                                                                    View</span></a></li>
                                                                        <li><a href="complete-order.html">Complete
                                                                                Order</a></li>
                                                                        <li><a href="my-account-information.html">Account
                                                                                Information</a></li>
                                                                    </ul>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <ul class="nav">
                                                                        ...
                                                                        <li><a
                                                                                href="sitemap.html"><span>Sitemap</span></a>
                                                                        </li>
                                                                        <li><a href="track-order.html"><span>Track
                                                                                    Order</span></a></li>
                                                                        <li><a href="register-ac.html"><span>Register
                                                                                    Account</span></a></li>
                                                                        <li><a href="forgot-password.html"><span>Forgot
                                                                                    Password</span></a></li>
                                                        ...
                                                        <div class="popup">
                                                            <div class="row">
                                                                <div class="col-md-4 col-sm-6">
                                                                    <h3><a href="shop-grid-sidebar.html">Clothing</a>
                                                                    </h3>
                                                                    <ul class="nav">
                                                                        <li><a
                                                                                href="shop-grid-sidebar.html">T-Shirts</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Shirts</a>
                                                                        </li>
                                                                        <li><a
                                                                                href="shop-grid-sidebar.html">Trousers</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Sleep
                                                                                Wear</a></li>
                                                                    </ul>
                                                                    <br>
                                                                    <h3><a href="shop-grid-sidebar.html">Shoes</a></h3>
                                                                    <ul class="nav">
                                                                        <li><a href="shop-grid-sidebar.html">Flat
                                                                                Shoes</a></li>
                                                                        <li><a href="shop-grid-sidebar.html">Flat
                                                                                Sandals</a></li>
                                                                        <li><a href="shop-grid-sidebar.html">Boots</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Heels</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="col-md-4 col-sm-6 has-sep">
                                                                    <h3><a href="shop-grid-sidebar.html">Jwellery</a>
                                                                    </h3>
                                                                    <ul class="nav">
                                                                        <li><a
                                                                                href="shop-grid-sidebar.html">Bracelets</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Necklaces
                                                                                &amp; Pendent</a></li>
                                                                        <li><a
                                                                                href="shop-grid-sidebar.html">Pendants</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Pins &amp;
                                                                                Brooches</a></li>
                                                                    </ul>
                                                                    <br>
                                                                    <h3><a href="shop-grid-sidebar.html">Watches</a>
                                                                    </h3>
                                                                    <ul class="nav">
                                                                        <li><a
                                                                                href="shop-grid-sidebar.html">Fastrack</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Casio</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Sonata</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Maxima</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                    ...
                                                                    <div class="custom-menu-right">
                                                                        <div class="box-banner media">
                                                                            <div class="add-right"><a
                                                                                    href="#"><img
                                                                                        src="fabulous/images/jtv-menu-banner1.jpg"
                                                                                        class="img-responsive"
                                                                                        alt="New Arrive"></a></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            <a href="#" class="ads"><img
                                                                    src="fabulous/images/jtv-menu-banner4.jpg" alt="Mega Sale"
                                                        ...
                                                        <div class="popup">
                                                            <div class="row">
                                                                <div class="col-md-4 col-sm-6">
                                                                    ...
                                                                    <ul class="nav">
                                                                        <li><a href="shop-grid-sidebar.html">Dress
                                                                                sale</a></li>
                                                                        <li><a href="shop-grid-sidebar.html">Sarees</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Kurta &
                                                                                kurti</a></li>
                                                                        <li><a href="shop-grid-sidebar.html">Dress
                                                                                materials</a></li>
                                                                        <li><a href="shop-grid-sidebar.html">Salwar
                                                                                kameez sets</a></li>
                                                                    </ul>
                                                                    <br>
                                                                    <h3><a href="shop-grid-sidebar.html">Jewellery</a>
                                                                    </h3>
                                                                    <ul class="nav">
                                                                        <li><a href="shop-grid-sidebar.html">Rings</a>
                                                                        </li>
                                                                        <li><a
                                                                                href="shop-grid-sidebar.html">Earrings</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Jewellery
                                                                                sets</a></li>
                                                                        <li><a href="shop-grid-sidebar.html">Pendants &
                                                                                lockets</a></li>
                                                                        <li><a href="shop-grid-sidebar.html">Plastic
                                                                                jewellery</a></li>
                                                                    </ul>
                                                                </div>
                                                                <div class="col-md-4 col-sm-6 has-sep">
                                                                    <h3><a href="shop-grid-sidebar.html">Beauty</a>
                                                                    </h3>
                                                                    <ul class="nav">
                                                                        <li><a href="shop-grid-sidebar.html">Make
                                                                                up</a></li>
                                                                        <li><a href="shop-grid-sidebar.html">Hair
                                                                                care</a></li>
                                                                        <li><a
                                                                                href="shop-grid-sidebar.html">Deodorants</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Bath &
                                                                                body</a></li>
                                                                        <li><a href="shop-grid-sidebar.html">Skin
                                                                                care</a></li>
                                                                    </ul>
                                                                    <br>
                                                                    <h3><a href="shop-grid-sidebar.html">Footwear</a>
                                                                    </h3>
                                                                    <ul class="nav">
                                                                        <li><a href="shop-grid-sidebar.html">Flats</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Heels</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Boots</a>
                                                                        ...
                                                                        <li><a
                                                                                href="shop-grid-sidebar.html">Slippers</a>
                                                                        </li>
                                                                        <li><a href="shop-grid-sidebar.html">Shoes</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="col-md-4 has-sep hidden-sm">
                                                                    <div class="custom-menu-right">
                                                                        <div class="box-banner media">
                                                                            ...
                                                                            <div class="add-right"><img
                                                                                    src="fabulous/images/jtv-menu-banner2.jpg"
                                                                                    alt="Top Glass"
                                                                        ...
                                                                        <div class="box-banner media">
                                                                            ...
                                                                            <div class="add-right"><img
                                                                                    src="fabulous/images/jtv-menu-banner3.jpg"
                                                                                    alt="Save 35%"
                                                                                    class="img-responsive"></div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <li class="nosub"><a href="shop-grid-sidebar.html">Accessories</a>
                                                </li>
                                                <li><a href="blog.html">Blog</a>
                                                    <div class="wrap-popup column1">
                                                        <div class="popup">
                                                            <ul class="nav">
                                                                <li><a href="blog.html">Blog</a></li>
                                                                <li><a href="blog-archive.html">Blog Archive</a></li>
                                                                <li><a href="blog_single_post.html">Blog Single</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="side-banner"><img src="fabulous/images/top-banner.jpg"
                                                    alt="Flash Sale" class="img-responsive"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-9 col-sm-9 col-xs-12 jtv-rhs-header">
                            <div class="jtv-mob-toggle-wrap">
                                <div class="mm-toggle"><i class="fa fa-reorder"></i><span
                                    ...
                                    <div class="search-box hidden-xs">
                                        <form id="search_mini_form" action="#" method="get">
                                            <input id="search" type="text" name="q" value=""
                                                class="searchbox" placeholder="Search entire store here..."
                                                maxlength="128">
                                    ...
                                    <div class="right_menu">
                                        <div class="menu_top">
                                            <div class="top-cart-contain pull-right">
                                                <div class="mini-cart">
                                                    <div class="basket"><a class="basket-icon" href="#"><i
                                                                class="fa fa-shopping-basket"></i> Shopping Cart
                                                            <span>3</span></a>
                                                        <div class="top-cart-content">
                                                            <div class="block-subtitle">
                                                                <div class="top-subtotal">3 items, <span
                                                                        class="price">$399.49</span></div>
                                                            </div>
                                                            <ul class="mini-products-list" id="cart-sidebar">
                                                                <li class="item">
                                                                    <div class="item-inner"><a class="product-image"
                                                                            ...
                                                                            href="product-detail.html"><img
                                                                                ...
                                                                                src="fabulous/images/products/product-fashion-1.jpg"></a>
                                                                        <div class="product-details">
                                                                            <div class="access"><a class="btn-remove1"
                                                                                    title="Remove This Item"
                                                                                    href="#">Remove</a> <a
                                                                                    class="btn-edit" title="Edit item"
                                                                                    href="#"><i
                                                                                        class="fa fa-pencil"></i><span
                                                                                        class="hidden">Edit
                                                                                        item</span></a> </div>
                                                                            <p class="product-name"><a
                                                                                    href="product-detail.html">Product
                                                                                    tilte is here</a></p>
                                                                            <strong>1</strong> x <span
                                                                                class="price">$119.99</span>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="item">
                                                                    <div class="item-inner"><a class="product-image"
                                                                            ...
                                                                            href="product-detail.html"><img
                                                                                alt="Product tilte is here"
                                                                                src="fabulous/images/products/product-fashion-3.jpg"></a>
                                                                        <div class="product-details">
                                                                            <div class="access"><a class="btn-remove1"
                                                                                    title="Remove This Item"
                                                                                    href="#">Remove</a> <a
                                                                ...
                                                                <li class="item">
                                                                    <div class="item-inner"><a class="product-image"
                                                                            ...
                                                                            href="product-detail.html"><img
                                                                                alt="Product tilte is here"
                                                                                src="fabulous/images/products/product-fashion-4.jpg"></a>
                                                                        <div class="product-details">
                                                                            <div class="access"><a class="btn-remove1"
                                                                                    title="Remove This Item"
                                                                                    href="#">Remove</a> <a
                                                                            ...
                                                                            <p class="product-name"><a
                                                                                    ...
                                                                                    tilte is here</a></p>
                                                                            <strong>1</strong> x <span
                                                                                class="price">$99.89</span>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                            <div class="actions"> <a href="shopping-cart.html"
                                                                    class="view-cart"><span>View Cart</span></a>
                                                                <button onclick="window.location.href='checkout.html'"
                                                                    class="btn-checkout" title="Checkout"
                                ...
                                <div class="top_section hidden-xs">
                                    <div class="toplinks">
                                        <div class="site-dir hidden-xs"> <a class="hidden-sm" href="#"><i
                                                ...
                                                7890</a> <a href="mailto:support@example.com"><i
                                                    class="fa fa-envelope"></i> support@example.com</a> </div>
                                        <ul class="links">
                                            <li><a title="My Account" href="my-account.html">My Account</a></li>
        ...
        <footer>
                    ...
                    <div class="container">
                        <div class="heading text-center">
                            ...
                            <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec faucibus maximus
                                vehicula. Sed feugiat, tellus vel tristique posuere.</span>
                        </div>
                        <form>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="contacts-info">
                                ...
                                <div class="email-footer"><i class="fa fa-envelope"></i> <a
                                        href="mailto:support@example.com">support@example.com</a> </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="payment-accept">
                                ...
                                <div class="payment-icon"><img src="fabulous/images/paypal.png" alt="paypal"> <img
                                        src="fabulous/images/visa.png" alt="visa"> <img src="fabulous/images/american-exp.png"
                                        alt="american express"> <img src="fabulous/images/mastercard.png" alt="mastercard">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12 coppyright text-center">© 2018 Fabulous, All rights reserved.
                        </div>
                    </div>
                </div>
            </div>
